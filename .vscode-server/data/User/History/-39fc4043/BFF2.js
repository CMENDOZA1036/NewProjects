...
const coupon = document.querySelector ('#InputCoupon')
...
button2.addEventListener('click', coupon)
...
function coupon () {
  ...
  if (Valuecoupon == 'Franco') {
   ...
   //*Con esta Variable llamamos el calculo de la funcion porcentajes
  const calculo = coupons (ValuePrice, Valuecoupon)
