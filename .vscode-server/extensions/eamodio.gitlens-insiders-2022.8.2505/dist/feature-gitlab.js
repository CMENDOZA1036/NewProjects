...
}`,P=await this.graphql(e,t,a?.baseUrl,d,{fullPath:`${r}/${i}`,iid:String(u)},h);if(((s=(o=P?.data)==null?void 0:o.project)==null?void 0:s.issue)!=null){const v=P.data.project.issue;return{provider:e,type:m.m.Issue,id:v.iid,date:new Date(v.createdAt),title:v.title,closed:v.state==="closed",closedDate:v.closedAt==null?void 0:new Date(v.closedAt),url:v.webUrl}}if(((n=(l=P?.data)==null?void 0:l.project)==null?void 0:n.mergeRequest)!=null){const v=P.data.project.mergeRequest;return{provider:e,type:m.m.PullRequest,id:v.iid,date:new Date(v.createdAt),title:v.title,closed:v.state==="closed",closedDate:v.state==="closed"?new Date(v.updatedAt):void 0,url:v.webUrl}}return}catch(d){if(d instanceof c.Ww)return;throw this.handleException(d,e,h)}}async getPullRequestForBranch(e,t,r,i,u,a){var o,s,l,n,h,d,P,v,F,K,N,Y,H,J,z,X,Z,Q,V,k,ee,te;const ae=(0,_.UH)();try{const q=`
			nodes {
				iid
				author {
					name
